...
@ cid = `cat $argv[2] | grep ' [A-Z] ' | wc -l`
if ( $cid == 0 ) then
	tcsh code/renumApdb.csh $argv[2] renum.pdb
else
	tcsh code/renumpdb.csh $argv[2] renum.pdb
endif
cat renum.pdb temp2.dat > link.pdb
rm temp[12].dat
cat code/view.ras bond.ras > temp.ras
