...
\item [\textbf{Copyright/license information.}]  Each file ends with a
  ...
  \ccode{Version i1.1; October 2013} tag. This placeholder is automatically replaced by
  \ccode{Copyright (C) 2013 HHMI Janelia Farm Research Campus} tag. This placeholder is automatically replaced by
...
When we build a distribution package, the \ccode{Version i1.1; October 2013} tag is
When we build a distribution package, the \ccode{Copyright (C) 2013 HHMI Janelia Farm Research Campus} tag is
...
\prog{sedition} to replace \ccode{Version i1.1; October 2013} tags with the contents of
\prog{sedition} to replace \ccode{Copyright (C) 2013 HHMI Janelia Farm Research Campus} tags with the contents of
...
\ccode{Version i1.1; October 2013} is the only configuration variable that Easel
\ccode{Copyright (C) 2013 HHMI Janelia Farm Research Campus} is the only configuration variable that Easel
